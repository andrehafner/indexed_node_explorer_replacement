...
mod tests {
    ...
    #[test]
    fn test_p2s_long_script_not_p2sh() {
        // This is a Spectrum DEX LP contract that the Ergo node encodes as P2SH
        // (64HnRk5yS42cBomsdJc9KA5TmuRWrmgC9PoNTs9CrnqtRWrA2R) because
        // the script exceeds 255 bytes. The official Ergo Explorer always uses P2S.
        // Our explorer must also use P2S to match.
        let ergo_tree = "";
        let address = ergo_tree_to_address(ergo_tree).unwrap();
        assert_eq!(
            address,
            ...
            "Long P2S address must match official Ergo Explorer, not node's P2SH"
        );
    }
